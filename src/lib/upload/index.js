...
function sendPost (upData) {
    ...
    if (publicApp() && publicApp().AnalysysAgent.encrypt && Util.paramType(publicApp().AnalysysAgent.encrypt.uploadData) === 'Function') {
    ...
    request({
        ...
        dataType: baseConfig.base.dataType || "json",
